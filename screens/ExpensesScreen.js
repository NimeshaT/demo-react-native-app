...
export default class ExpensesScreen extends Component {
  ...
  getData(nic) {
    ...
    return fetch('http://192.168.8.101:3000/exchange/oneexchange/' + nic)
    ...
    return (
      <Container>
        <Header style={styles.Header}>
          ...
          <Body>
            <Title style={styles.Title}>Exchanges Here...</Title>
          </Body>
        </Header>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Footer >
            <FooterTab style={styles.Footer}>
              ...
              <Button vertical onPress={() => this.props.navigation.navigate('ExpensesScreen', { nic: nic }), this.getData(nic)}>
